...
/obj/structure/fluff/walldeco/vinez/glow/Initialize(mapload) //OV EDIT
	. = ..()
...
/obj/structure/fluff/walldeco/vinez/glow/blue/Initialize(mapload) //OV EDIT
	. = ..()
...
/obj/structure/fluff/walldeco/vinez/glow/red/Initialize(mapload) //OV EDIT
	. = ..()
