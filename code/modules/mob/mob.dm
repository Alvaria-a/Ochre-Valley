...
/atom/proc/visible_message(message, self_message, blind_message, vision_distance = DEFAULT_MESSAGE_RANGE, list/ignored_mobs, runechat_message = null, log_seen = NONE, log_seen_msg = null)
	...
	var/list/hearers = get_get_hearers_in_view_in_view(vision_distance, src) //caches the hearers and then removes ignored mobs. // OV Edit: this must be get_hearers_in_view or vore breaks, remove when upstream fixes this
...
/atom/proc/audible_message(message, deaf_message, hearing_distance = DEFAULT_MESSAGE_RANGE, self_message, runechat_message = null, log_seen = NONE, log_seen_msg = null, custom_spans = list("emote"), used_language = /datum/language/common)
	var/list/hearers = get_get_hearers_in_view_in_view(hearing_distance, src) // OV Edit: this must be get_hearers_in_view or vore breaks, remove when upstream fixes this
...
/atom/proc/loud_message(message, hearing_distance = DEFAULT_MESSAGE_RANGE, directional = TRUE)
	var/list/listening = get_get_hearers_in_view_in_view(hearing_distance, src) // OV Edit: this must be get_hearers_in_view or vore breaks, remove when upstream fixes this
